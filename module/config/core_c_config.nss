...
int DEBUG_LOGGING = DEBUG_LOG_FILE | DEBUG_LOG_LIST;
...
const string INSTALLED_LIBRARIES = "*_l_plugin,*_p_*";
...
const int AUTO_HOOK_AREA_HEARTBEAT_EVENT = TRUE;
...
/// this to FALSE.
const int INCLUDE_NPC_IN_AOE_ROSTER = FALSE;
